  ...
  return (
    <div>
        <div style={{backgroundImage: `url(${image})`, backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed" }} className="w-full h-screen">
            <div className="w-full h-screen" style={{ background: "rgba(72, 72, 72, 0.4)", background: "-webkit-linear-gradient(top, rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.2))", background: "-moz-linear-gradient(top, rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.2))", background: "linear-gradient(to bottom, rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.2))"}}>
                ...
                <div className="h-4/5 flex justify-center items-center">
                    ...
                    {
                        loginBox &&
                        <div className="fixed top-0 left-0 right-0 bottom-0 w-full min-h-full bg-black bg-opacity-50 flex justify-center">
                            <div className="md:w-[420px] h-full bg-white relative flex flex-col justify-center">
                                <p onClick={() => setLoginBox(false)} className="absolute right-4 top-1 w-8 h-8 rounded-full text-center border-2 border-gray-300 cursor-pointer text-gray-300 transition-all hover:border-gray-600 hover:text-gray-600 hover:rotate-90"><CloseIcon sx={{ width: 22 , height: 22 }} /></p>
                                <div className="flex flex-col items-center justify-center px-10">
                                    <img src={logoIcon} width="35px" />
                                    <h2 className="text-2xl italic font-bold my-4 text-[#21262e]">CREATE ACCOUNT</h2>
                                    <p className="font-normal mb-2 text-[#21262e] text-center leading-5 text-sm">By clicking Log In, you agree to our <a href="#" className="underline text-gray-600">Terms</a>. Learn how we process your data in our <a href="#" className="underline text-gray-600">Privacy Policy</a>. and <a href="#" className="underline text-gray-600">Cookie Policy</a>.</p>
                                    <div onClick={() => signInWithGoogle()} className="border-2 border-gray-300 rounded-full mt-4 w-full px-4 py-3 flex items-center gap-10 cursor-pointer text-gray-600 transition-all hover:text-gray-900">
                                        <img src={googleIcon} width="25px" />
                                        <span className="font-medium">LOG IN WITH GOOGLE</span>
                                    </div>
                                    <div onClick={() => signInWithFacebook()} className="border-2 border-gray-300 rounded-full mt-4 w-full px-4 py-3 flex items-center gap-10 cursor-pointer text-gray-600 transition-all hover:text-gray-900">
                                        <img src={facebookIcon} width="25px" />
                                        <span className="font-medium">LOG IN WITH FACEBOOK</span>
                                    </div>
                                    <a href="#" className="mt-4 underline text-gray-600">Trouble Logging In?</a>
                                    <hr className="border-gray-300 mt-6 w-full" />
                                    <h2 className="text-2xl italic font-bold my-4 text-[#21262e]">GET THE APP!</h2>
                                    <div className="flex items-center gap-4">
                                        <img src={appStore} className="w-36 h-12 cursor-pointer" />
                                        <img src={googlePlay} className="w-40 h-[70px] cursor-pointer" />
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div className="flex justify-center">
            <div className="bg-white grid grid-cols-3 py-8 gap-4 md:w-10/12 max-w-7xl">
        ...
        <div className="flex justify-center">
            <div className="grid grid-cols-5 py-8 md:w-10/12 max-w-7xl border-b border-gray-300">
                <div className="mr-20">
        ...
        <div className="flex justify-center mt-6">
            <div className="flex flex-col md:w-10/12 max-w-7xl pb-4 border-b border-gray-300">
        ...
        <div className="flex justify-center">
            <div className="flex justify-between md:w-10/12 max-w-7xl mt-4 mb-10">
                <ul className="flex gap-2">
                    <li className="text-[#505965] text-sm cursor-pointer hover:text-[#d6002f]">FAQ /</li>
                    <li className="text-[#505965] text-sm cursor-pointer hover:text-[#d6002f]">Safety Tips /</li>
                    <li className="text-[#505965] text-sm cursor-pointer hover:text-[#d6002f]">Terms /</li>
                    <li className="text-[#505965] text-sm cursor-pointer hover:text-[#d6002f]">Cookie Policy /</li>
                    <li className="text-[#505965] text-sm cursor-pointer hover:text-[#d6002f]">Privacy Settings</li>
                </ul>
                <p className="text-[#505965] text-sm">2022 Match Group, LLC, All Rights Reserved.</p>
            </div>
        </div>
    </div>
  )
